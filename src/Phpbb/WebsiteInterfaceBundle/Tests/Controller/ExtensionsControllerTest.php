...
class ExtensionsControllerTest extends BootstrapTestSuite
{
    ...
    public function testExtensionsRules()
    {
        ...
        // Content Check
        $this->assertTrue($crawler->filter('html:contains("Licensing your Extension")')->count() > 0, 'Extensions Rules Content Check');
        $this->assertTrue($crawler->filter('html:contains("Extensions Team")')->count() > 0, 'Extensions Sidebar Check');
    ...
    public function testExtensionsRecDevs()
    {
        ...
        // Content Check
        $this->assertTrue($crawler->filter('html:contains("Do you write great code?")')->count() > 0, 'Extensions Recognised Dev Content Check');
        $this->assertTrue($crawler->filter('html:contains("Extensions Team")')->count() > 0, 'Extensions Sidebar Check');
    ...
    public function testExtensionsOfficialExts()
    {
        ...
        // Content Check
        $this->assertTrue($crawler->filter('html:contains("These are extensions created and maintained by the")')->count() > 0, 'Extensions Official Exts Content Check');
        $this->assertTrue($crawler->filter('html:contains("Extensions Team")')->count() > 0, 'Extensions Sidebar Check');
    ...
    public function testExtensionsOfficialExtsTeam()
    {
        ...
        // Content Check
        $this->assertTrue($crawler->filter('html:contains("The Extensions Development Team are extension Authors that work under the mentorship of the Extensions Team to create")')->count() > 0, 'Extensions Dev Team Content Check');
        $this->assertTrue($crawler->filter('html:contains("Extensions Team")')->count() > 0, 'Extensions Sidebar Check');
    ...
    public function testExtensionsInstalling()
    {
        ...
        // Content Check
        $this->assertTrue($crawler->filter('html:contains("Installing an Extension")')->count() > 0, 'Extensions Installing Content Check');
        $this->assertTrue($crawler->filter('html:contains("Extensions Team")')->count() > 0, 'Extensions Sidebar Check');
    ...
    public function testExtensionsWriting()
    {
        ...
        // Content Check
        $this->assertTrue($crawler->filter('html:contains("How to write an extension")')->count() > 0, 'Extensions Writing Content Check');
        $this->assertTrue($crawler->filter('html:contains("Extensions Team")')->count() > 0, 'Extensions Sidebar Check');
