...
class GlobalsExtension extends \Twig_Extension
{
	...
	private function getModsVars()
	{
		$modVars = array(
			...
			'MODS_MEAL'			=> '/mods/pre-validator/',
			'MODS_MEAL_TOPIC'		=> '/community/viewtopic.php?t=474876',
			'MODS_MEAL_DOCS'		=> '/mods/documentation/tools/meal/',
			'MODS_AMV'			=> '/mods/pre-validator/',
			'MODS_AMV_TOPIC'		=> '/community/viewtopic.php?t=474876',
			'MODS_AMV_DOCS'		=> '/mods/documentation/tools/amv/',
